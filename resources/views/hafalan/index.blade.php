<x-app-layout>
    ...
    <div class="space-y-6">
        @if ($hafalan->isEmpty())
            <div
                class="rounded-xl border border-gray-200 bg-white p-8 text-center shadow-sm sm:p-12 dark:border-gray-700 dark:bg-gray-800">
                ...
                <div
                    ...
                    <div class="space-y-3 p-4 sm:p-6">
                        @foreach ($ayahs as $hafalanItem)
                            <div
                                class="flex items-center justify-between rounded-lg bg-gray-50 p-3 transition hover:bg-gray-100 sm:p-4 dark:bg-gray-700/50 dark:hover:bg-gray-700">
                                <div class="flex items-center space-x-3">
                                    ...
                                    <span class="text-sm text-gray-900 sm:text-base dark:text-white">Ayat
                                ...
                                <div>
                                    ...
                                    @elseif($hafalanItem->status === 'sedang_dihafal')
                                        <span
                                            class="rounded-full bg-yellow-100 px-3 py-1 text-xs font-medium text-yellow-700 sm:text-sm dark:bg-yellow-900 dark:text-yellow-300">
                                            Menghafal</span>
                                    @else
                                        <span
                                            class="rounded-full bg-gray-200 px-3 py-1 text-xs font-medium text-gray-700 sm:text-sm dark:bg-gray-600 dark:text-gray-300">○
                                            Belum</span>
                                    @endif
                                </div>
                            </div>
